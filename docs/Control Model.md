...
The subscription mechanism is described further in [Events, Notifications and Subscriptions](Framework%20Mechanisms.md#103-events-notifications-and-subscriptions).
...
- The **Blocks** subtree contains the definition of **ncaBlock** - see [Blocks](Device%20Model.md#81-blocks).
...
- The **Managers** subtree contains definitions of classes that perform Device housekeeping functions. Each manager class may be instantiated at most once per NCA device. A few of them must be instantiated for NCA conformance - see [Base Device Schema](Device%20Model.md#8221-base-device-schema).
